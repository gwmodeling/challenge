...
df_in <-  read_csv('data/Sweden_1/input_data.csv') %>% 
  rename(Date = time) %>% 
...
df_head <-  read_csv('data/Sweden_1/heads.csv')
...
df_train <- df %>% 
  filter(between(Date, date('2001-01-01'), date('2015-12-31')))
...
write_rds(df_stoch, 'submissions/team_Mirkwood/df_stoch_Sweden_1.rds')


df_stoch <- read_rds('submissions/team_Mirkwood/df_stoch_Sweden_1.rds')
...
submission_csv <- read_csv('submissions/team_Mirkwood/submission_form_Sweden_1.csv') %>% 
  dplyr::select(Date)
...
left_join(submission_csv, df_out) %>% 
  write_csv('submissions/team_Mirkwood/submission_form_Sweden_1_completed.csv')

write_csv(df_out, 'submissions/team_Mirkwood/full_time_series_Sweden_1.csv')