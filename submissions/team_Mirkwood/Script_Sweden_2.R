...
df_in <-  read_csv('data/Sweden_2/input_data.csv') %>% 
  rename(Date = time) %>% 
...
df_head <-  read_csv('data/Sweden_2/heads.csv')
...
write_rds(df_stoch, 'submissions/team_Mirkwood/df_stoch_Sweden_2.rds')


df_stoch <- read_rds('submissions/team_Mirkwood/df_stoch_Sweden_2.rds')
...
submission_csv <- read_csv('submissions/team_Mirkwood/submission_form_Sweden_2.csv') %>% 
  dplyr::select(Date)
...
left_join(submission_csv, df_out) %>% 
  write_csv('submissions/team_Mirkwood/submission_form_Sweden_2_completed.csv')

write_csv(df_out, 'submissions/team_Mirkwood/full_time_series_Sweden_2.csv')